...
public class RootDirectoryEntry {
	...
	public RootDirectoryEntry(char entryNumber, long entryAddress, byte buffer[])
	{
	...
	public void getAttributes(byte buffer[])
	{
		...
		//File atributes
				char fileAttributes = DataConverter.getValueFrom1Byte(buffer, (int)entryAddress + 11);
